...
class ZekerModel
{
 ...
 static Future<List<ZekerModel>> getListOfRepeats(BuildContext context) async {
  ...
  static Future<List<ZekerModel>> getList(BuildContext context,String fileName) async {
    String data = await DefaultAssetBundle.of(context).loadString("assets/json/$fileName.json");
