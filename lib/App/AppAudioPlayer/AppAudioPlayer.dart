...
class AppAudioPlayer extends StatefulWidget {
  ...
  const AppAudioPlayer({Key? key, required this.model, required this.list})
      : super(key: key);
    ...
    for (int i = 0; i < widget.list.length; i++) {
      ...
      lst.add(AudioSource.uri(
        ...
        tag: MediaItem(
            ...
            title: temp.title,
            artUri:
                Uri.parse('images/app/bgSound.jpg') // "images/app/bgSound.jpg",
            ),
      ));
    }
    ...
    _playlist = ConcatenatingAudioSource(children: [
      if (kIsWeb ||
        ...
        ClippingAudioSource(
          // start: const Duration(seconds: 60),
          // end: const Duration(seconds: 90),
          child: AudioSource.uri(Uri.parse(widget.model.url)),
          tag: MediaItem(
              id: widget.model.itemId,
              album: widget.model.titleParent,
              title: widget.model.title,
              artUri: Uri.parse(
                  'https://media.wnyc.org/i/1400/1400/l/80/1/ScienceFriday_WNYCStudios_1400.jpg') // "images/app/bgSound.jpg",
              ),
        ),
    ]);
