...
class example_radio extends StatefulWidget {
  const example_radio({Key? key}) : super(key: key);

  @override
  MyAppState createState() => MyAppState();
}

class MyAppState extends State<example_radio> with WidgetsBindingObserver {
