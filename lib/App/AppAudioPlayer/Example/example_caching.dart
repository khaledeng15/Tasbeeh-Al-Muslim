...
class example_caching extends StatefulWidget {
  const example_caching({Key? key}) : super(key: key);

  @override
  MyAppState createState() => MyAppState();
}

class MyAppState extends State<example_caching> with WidgetsBindingObserver {
