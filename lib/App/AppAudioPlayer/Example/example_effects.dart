...
class example_effects extends StatefulWidget {
  const example_effects({Key? key}) : super(key: key);

  @override
  MyAppState createState() => MyAppState();
}

class MyAppState extends State<example_effects> with WidgetsBindingObserver {
