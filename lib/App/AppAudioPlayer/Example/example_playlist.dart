...
class example_playlist extends StatefulWidget {
  const example_playlist({Key? key}) : super(key: key);

  @override
  MyAppState createState() => MyAppState();
}

class MyAppState extends State<example_playlist> with WidgetsBindingObserver {
