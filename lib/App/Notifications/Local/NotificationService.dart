...
import '../../AzkarMaker/model/zekerModel.dart';
...
class NotificationService {
  ...
  // static const String CHANNEL_DESCRIPTION = "";
   ...
   AndroidNotificationDetails androidPlatformChannelSpecifics(ZekerModel zekerModel){ 
  return      AndroidNotificationDetails(
    ...
    sound: zekerModel.soundFileName() , // Specifics the file path to play (only from iOS 10 onwards)
